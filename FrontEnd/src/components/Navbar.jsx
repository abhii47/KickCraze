...
function Navbar() {
  return (
    <div className='Navbar-container bg-zinc-100 text-black w-screen'>
        ...
        <div className='Navbar bg-zinc-200 text-center flex items-center justify-between h-20 drop-shadow-md' >
            ...
            <div className='Navbar-icons w-[33%] flex justify-end gap-5 pr-6 text-[#415a77]'>
        ...
        <div className='header-policy flex justify-center items-center gap-8 text-sm text-white box-content bg-[#415a77] rounded-lg mx-[23%] my-3 py-3 overflow-scroll' >
            <a href="">Category</a>
